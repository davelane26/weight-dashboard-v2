...
android {
    ...
    signingConfigs {
        // Use a checked-in / cached-in-CI debug keystore so every APK we
        // ship is signed with the SAME cert — lets Android install our
        // builds as updates instead of "package conflicts" errors.
        // The keystore itself has no secrets (password is literally
        // "android", the Android debug convention). File lives at
        // app/debug.keystore — generated by GitHub Actions if missing.
        getByName("debug") {
