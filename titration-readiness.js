...
(function () {
  ...
  const CLEAN_MIN_READINGS    = 5;     // need this many clean-day readings before clean trend overrides raw
                                       // (low floor — noisy slope, but lets sparse loggers see the signal)
