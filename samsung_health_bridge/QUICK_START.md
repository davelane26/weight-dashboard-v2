...
## Step 3 - Clone the dashboard repo

Only ONE repo now (the previous version of this doc said two - that
was wrong; Weight-tracker is private, so health.json goes in the public
weight-dashboard-v2 repo instead).

```powershell
cd C:\Users\djtwo\Downloads
git clone https://<YOUR_PAT>@github.com/davelane26/weight-dashboard-v2.git
```
...
```json
{
  ...
  "dashboard_repo": "C:/Users/djtwo/Downloads/weight-dashboard-v2",
...
1. Check https://github.com/davelane26/weight-dashboard-v2/commits/main -
   you should see a fresh `health.json auto-update ...` commit from
   moments ago.
2. Wait ~60 seconds for GitHub Pages to deploy, then open
   https://davelane26.github.io/weight-dashboard-v2/health.json in a
